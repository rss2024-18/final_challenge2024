...
class LaneSegmentation(Node):
    ...
    def __init__(self):
        ...
        self.cone_pub = self.create_publisher(Point, "/pixel", 10)
        self.debug_pub = self.create_publisher(Image, "/debug", 10)
        self.image_sub = self.create_subscription(Image,
                                                  "/zed/zed_node/rgb/image_rect_color",
                                                  self.image_callback,
                                                  10)
        #self.image_sub = self.create_subscription(Image, "/zed/zed_node/rgb/image_rect_color", self.image_callback_please, 10)
    ...
    def image_callback(self, image_msg):
        ...
        if right_lines_final:
            #self.get_logger().info("if right_lines_final")
        ...
        if left_lines_final:
            #self.get_logger().info("left_lines_final")
        ...
        if right_lines_final and left_lines_final:
            ...
            cone_location = Point()
            cone_location.x = translated_x
            cone_location.y = translated_y
